...
<head>
    <meta charset="utf-8">
    <title>Yearly Export - {{ $year }}</title>
    <style>
...
<body>
    <h1>Yearly Export Report - {{ $year }}</h1>
    ...
    <div class="summary-box">
        ...
        <strong>Regular Users:</strong> {{ $usersByRole['user'] }}<br>
        <strong>Total Items Sold:</strong> {{ $products->count() }}<br>
        <strong>Total Revenue:</strong> ₱{{ number_format($products->sum('price'), 2) }}<br>
        <strong>Total Listed Items:</strong> {{ $listedItems->count() }}<br>
        <strong>Total Works:</strong> {{ $works->count() }}<br>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $monthData['users'] }}</td>
                <td>{{ $monthData['soldProducts'] }}</td>
                <td>₱{{ number_format($monthData['totalSales'], 2) }}</td>
                <td>{{ $monthData['works'] }}</td>
                <td>{{ $monthData['donations'] }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="4">No users registered this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="3">No upcyclers registered this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="5">No sold products this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6">No listed items this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="5">No upcycled works this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="5">No reports this year.</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6">No donations this year.</td></tr>
            @endforelse
        </tbody>
    </table>
</body>
