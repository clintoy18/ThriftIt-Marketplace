@props(['categories', 'barangays', 'selectedCategoryId' => null, 'selectedBarangayId' => null])
    ...
    <div x-data="{ open: false, categorySearch: '' }" class="relative z-[100]">
        <button @click="open = !open"
            ...
            <span id="categoryButtonText">
                ...
                {{ isset($selectedCategoryId) && $categories->where('id', $selectedCategoryId)->first() ? $categories->where('id', $selectedCategoryId)->first()->name : 'Category' }}
            </span>
