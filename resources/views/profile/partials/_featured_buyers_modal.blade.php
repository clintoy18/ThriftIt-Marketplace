        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl transform transition-all w-full max-w-2xl mx-auto overflow-hidden"
            ...
            <form action="{{ route('featured-buyers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                        <div class="space-y-1">
                            ...
                            <input type="text" name="name" required placeholder="e.g. Alexa Rivera" class="w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:ring-[#634600] focus:border-[#634600] text-sm">
                        </div>
                        <div class="space-y-1">
                            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Social Handle</label>
                            <input type="text" name="handle" placeholder="@username" class="w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white focus:ring-[#634600] focus:border-[#634600] text-sm">
                        </div>
                        <div class="md:col-span-2 space-y-1">
                            ...
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 dark:border-gray-700 border-dashed rounded-xl hover:border-[#634600] transition-colors relative">
                                <div class="space-y-1 text-center" x-show="!avatarPreview">
                                    ...
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                        <label class="relative cursor-pointer bg-transparent rounded-md font-medium text-[#634600] dark:text-[#D9D9D9] hover:text-[#7a5500] focus-within:outline-none">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <button type="button" @click="items.push({ id: Date.now() })" class="inline-flex items-center gap-1.5 text-xs font-bold text-[#634600] dark:text-[#D9D9D9] hover:text-white hover:bg-[#634600] border border-[#634600] dark:border-[#D9D9D9] px-3 py-1.5 rounded-full transition-all">
                                ...
                                <div class="bg-gray-50 dark:bg-gray-900/40 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 relative group">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="md:col-span-2 space-y-1">
                                            ...
                                            <input type="text" :name="`items[${index}][product_name]`" required placeholder="Designer Trench Coat..." class="w-full text-sm rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-[#634600] focus:border-[#634600]">
                                        </div>
                                        <div class="space-y-1">
                                            <label class="text-[10px] font-bold text-gray-400 uppercase">Price (₱)</label>
                                            <input type="number" :name="`items[${index}][price]`" required placeholder="0.00" class="w-full text-sm rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-[#634600] focus:border-[#634600]">
                                        </div>
                                        <div class="space-y-1">
                                            ...
                                            <div class="space-y-2">
                                                <input type="file" 
                                                       ...
                                                       required 
                                                       class="block w-full text-xs text-gray-600 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-[#634600] file:text-white hover:file:bg-[#7a5500] file:cursor-pointer cursor-pointer border border-gray-300 dark:border-gray-600 rounded-lg p-2 focus:ring-[#634600] focus:border-[#634600]">
                ...
                <div class="px-6 py-4 bg-gray-50/50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-semibold text-white bg-[#634600] hover:bg-[#7a5500] rounded-xl shadow-lg shadow-[#634600]/20 dark:shadow-none transition-all">
                        Save Changes
                    </button>
                </div>
            </form>
