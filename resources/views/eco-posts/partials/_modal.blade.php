<x-app-layout>
    ...
    <div x-data="{ showPostModal: false }" class="relative min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div x-show="showPostModal" x-transition:enter="transition ease-out duration-300"
            ...
            @keydown.escape.window="showPostModal = false" x-cloak>
                ...
                <form action="{{ route('eco-posts.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="relative">
                        ...
                        <label for="modal-title"
                            class="absolute left-4 -top-3 bg-white dark:bg-gray-800 px-2 text-sm font-medium text-[#B59F84] transition-all duration-300 peer-placeholder-shown:top-4 peer-placeholder-shown:text-gray-500 peer-focus:-top-3 peer-focus:text-[#B59F84]">
                            Post Title
                        </label>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Add Image
                                (Optional)</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Video Link
                                (Optional)</label>
