...
<div class="lg:col-span-3 space-y-8">
    <div
        class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-6 mb-8">
    ...
    <div class="space-y-8">
        @forelse($posts->sortByDesc('created_at') as $post)
            <article
                class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden transform transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
                <header class="bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-5">
                    <div class="flex items-center justify-between text-white">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center text-xl font-bold">
                ...
                <div class="p-6">
                    ...
                    @if ($post->image)
                        <div
                            class="mb-6 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-lg">
                            <img src="{{ Storage::disk('s3')->url($post->image) }}" alt="Post Image"
        ...
        @empty
            <div
                class="text-center py-16 bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg rounded-3xl border border-dashed border-gray-300 dark:border-gray-600">
                <div
                    class="w-28 h-28 mx-auto bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/50 dark:to-teal-900/50 rounded-3xl flex items-center justify-center mb-6">
                    <svg class="w-14 h-14 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
